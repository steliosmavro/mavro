...
- **Multiple model support** - Choose from various AI models including ChatGPT, Claude, Gemini, and open source alternatives
- **Open source first** - Fork, customize, and self-host with your own API keys
...
- **Rate limiting** - Fair usage limits prevent abuse while keeping it free
- **Optional premium features** - Power users can upgrade for more requests
- **Self-hosting** - Developers can use their own API keys for unlimited usage
...
Or try the [live demo](https://mavro.chat) - no signup required!
...
- A generous free tier for everyday use
- Affordable premium options for power users
...
- Check out the [live demo](https://mavro.chat) - no signup required
